...
select orderid,orderdate,custid,empid from TSQLV4.Sales.Orders
where orderdate like '2015-06%'
group by orderid,orderdate,custid,empid
...
select orderid,orderdate,custid,empid from TSQLV4.Sales.Orders
where (orderdate like '%31' or orderdate like '%30')
group by orderid,orderdate,custid,empid 
...
select empid,firstname,lastname from TSQLV4.HR.Employees
group by empid,firstname,lastname
having lastname like '%e%e%'
...
select orderid,sum(qty*unitprice) as totalvalue from TSQLV4.Sales.OrderDetails
group by orderid
...
-- Tables involved: Sales.OrderDetails table
select empid,lastname from TSQLV4.HR.Employees
...
-- Query 2 returns numorders whose maximum orderdate that is less than 20160501. Query 1 returns all numorders less than that value.
-- Query 1
...
-- Tables involved: Sales.Orders table
select top 3 shipcountry,avg(freight) as avgfreight from TSQLV4.Sales.Orders
...
declare @gender varchar(30)
	...
	end) from TSQLV4.HR.Employees
select empid,firstname,lastname,titleofcourtesy,@gender as gender from TSQLV4.HR.Employees
...
select empid,firstname,lastname,titleofcourtesy,
	case titleofcourtesy
		...
		end as gender from TSQLV4.HR.Employees
...
select custid,region from TSQLV4.Sales.Customers
